...
func TestKey_Sign(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "wantSuccess",
			args: args{
				Seed: []byte{48, 8, 36, 47, 99, 56, 185, 202, 74, 224, 107, 213, 53, 211, 127, 94, 231, 87, 120, 101, 76, 133, 17, 164, 225, 209, 126, 48, 21, 27, 206, 161, 240, 252, 151, 21, 18, 104, 55, 197, 129, 104, 173, 213, 252, 171, 38, 65, 15, 209, 60, 25, 250, 208, 49, 113, 66, 5, 251, 138, 189, 162, 64, 108},
